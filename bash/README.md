...
No __Linux__ tudo é representado em forma de __arquivo__, um usuário do terminal é represtentado como um arquivo, assim como os própios comandos, os hardwares conectados na máquina, diretórios e etc.
